    ...
    <div class="container">
      ...
      <div class="navigation collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav">
          <li style="color: #ffffff;" class="current"><a style="color: #ffffff;" href="#intro">Inicio</a></li>
          <li style="color: #ffffff;" ><a style="color: #ffffff;" href="#about">Sobre nós</a></li>
           <?php 
...
if($total_reg > 0){
         ?>
          ...
          <li style="color: #ffffff;" ><a style="color: #ffffff;" href="#services">Serviços</a></li>
        <?php } ?>
...
if($total_reg > 0){
         ?>
          <li style="color: #ffffff;" ><a style="color: #ffffff;" href="#portfolio">Portifólio</a></li>
        <?php } ?>
    ...
    if($i == 0){
      ...
      <?php } ?>
        ...
        <a class="carousel-control-prev" href="#introCarousel" role="button" data-slide="prev">
          ...
          <span class="sr-only">Pré view</span>
        </a>
    ...
    $imagem = $res[$i]['imagem'];
        ...
        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
          <div class="box-team wow bounceInUp" data-wow-delay="0.1s">
           <a href="https://www.instagram.com/silva_ngll/"> <img height="400px" width="210px" src="sistema/img/equipe/<?php echo $imagem ?>" alt="" class="img-circle img-responsive" /></a>
            <h4><?php echo $nome ?></h4>
            <p><?php echo $cargo ?></p>
          </div>
        </div>
...
<?php } ?>
      ...
      <div class="row" style="margin-top: -70px">
        ...
        <div class="col-md-4">
          <div class="contact-widget wow bounceInLeft">
            ...
            <a href="https://www.waze.com/live-map/directions/sao-paulo/ferraz-de-vasconcelos?utm_medium=lm_share_directions&utm_campaign=default&utm_source=waze_website&to=place.ws.row.30849643.none&from=ll.-23.5430868%2C-46.3580829"><h5>Endereço</h5>
            <p>
      ...
      <?php }else{
        ...
        <div class="<?php echo $colunas ?>">
          <div class="contact-widget wow bounceInRight">
            ...
            <a href="https://www.google.com/intl/pt-BR/gmail/about/"><h5>Email</h5>
            <p>
  ...
  <footer style="background: <?php echo $cor_sistema ?>">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
         <a href="https://sp.senai.br/unidade/suzano/
         "> <p><?php echo $texto_rodape ?></p></a>
